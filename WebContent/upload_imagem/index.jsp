...
<html >
<head>
<title>HTML5 Drag and Drop File Upload with Canvas Example</title>
...
<div id="droparea">
	<div class="dropareainner">
		<p class="dropfiletext">Arraste os arquivos para cá</p>
		<p>ou</p>
		<p><input id="uploadbtn" class="uploadbtn" type="button" value="Selecione os arquivos"/></p>
		
		<p class="extra">
			
			<input type="radio" id="grayscale" name="effect" value="grayscale" /><label for="grayscale">Efeito preto e branco</label>
			<input type="radio" id="sepia" name="effect" value="sepia" /><label for="sepia">Efeito Sépia</label>
		</p>
		<p>Obs: Após terminar o envio feche a janela.</p>
		<p id="err">Parece que o JavaScript não está funcionando!</p>
	</div>
...
<p class="message"><strong>Imagens Enviadas</strong>.</p>
