...
public class UsuarioBean {
	...
	public String getTextoIniUsuario() {
		...
		textoIniUsuario = "O seu email '"+this.getUser().getContato().getEmail()+"' ainda n�o foi confirmado.";
	...
	//SALVA ALTERA��ES GERAIS (CLASSE PRINCIPAL)
	public void salvar(){
	...
	public void salvarEmail(){
		...
		email1 = ats.get("email1");
			...
			//Lan�a um novo pedido de altera��o
			...
			addMessage("Enviamos um email para '"+email1+"' com um link de ativação para o novo email, as alteração estará ativa após a confirmação.");
	}
	
	
	//Recupera as todo as as perguntas recebidas do Usu�rio
