...
public class ImgDAO {
	...
	public Imagem getImg(long id_img){
	    ...
	    Debug.gerar("Modelo","ImgDAO","getTumb","A imagem de id "+id_img+" n�o foi encontrada");
	...
	public Imagem getLogo(long id_user){
	    ...
	    Debug.gerar("Modelo","getLogo","","A imagem do usuario "+id_user+" n�o foi encontrada");
	...
	//M�TODO PARA ORDENAR OS IDS DAS IMAGENS de acordo com  a capa
	...
	//M�todo para recupera��o de uma imagem de banner tempor�ria
	...
	//M�todo para inser�ao de imagem tempor�ria para o banner destaque
	...
	//M�TODO PARA TESTAR A INTEGRIDADE DAS IMAGENS NO BANCO DE DADOS
